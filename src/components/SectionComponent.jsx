...
export const SectionComponent = ({ order, img, title, parapraphe, subtitle, number }) => {
  ...
  return (
    <section className="grid md:grid-cols-2 justify-center wfull itms-center bg-ble-500 gap-12 px-4 md:px-16 lg:px-24 xl:px-40 2xl:px-52 ">
      ...
      <div ref={imageBackgroundRef} className={`w-full overflow-hidden bg-primary-50 p-12 pr-15 pl-12 rounded-3xl border-4 border-dark shadow-[0_5px_0_0_black]`}>
      {/* <img className="primary " ref={imageRef}  src={img} alt={title} /> */}
      <div className="relative">
      <img className="w-auto absolute top-23 -left-12" src="/img/Home/socialManagement/appList.png" alt="" />
      <img className="absolute bottom-22 left-35" src="/img/Home/socialManagement/Autopost.png" alt="" />
      <img className="" src="/img/Home/socialManagement/Description.png" alt="" />
      </div>
      </div>
      </div>
