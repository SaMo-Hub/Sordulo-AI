...
export const HomePage = ({  }) => {
  return (
    <div className={`bg-[#FFFAEC] custom-selection text-[#151B37] space-y-62 font-oldschol pt-12`}>
      ...
      <SectionComponetBottomTop part={1} number={2} subtitle={"Autres agences VS Nous"} title={"Le seul outil d'IA dont <br> vous aurez besoin."} parapraphe={"L'IA employé vous aide à transformer les prospects de n'importe quel canal en plus de missions, 24h/24 et 7j/7. Votre IA employé est configurée pour connaître votre entreprise et vos clients."}/>
      <SectionComponent part={3} order={0}  number={5} subtitle={"Autres agences VS Nous"} title={"Réservation entièrement automatisée"} parapraphe={"L'IA employé vous aide à transformer les prospects de n'importe quel canal en plus de missions, 24h/24 et 7j/7. Votre IA employé est configurée pour connaître votre entreprise et vos clients."}/>
      <SectionComponent part={1} order={1}  number={4} subtitle={"Autres agences VS Nous"} title={'Ne perdez plus jamais une autre avance'} parapraphe={"L'IA employé vous aide à transformer les prospects de n'importe quel canal en plus de missions, 24h/24 et 7j/7. Votre IA employé est configurée pour connaître votre entreprise et vos clients."}/>
      <SectionComponent part={2} order={0}  number={5} subtitle={"Autres agences VS Nous"} title={'Outils de gestion des médias sociaux'} parapraphe={"L'IA employé vous aide à transformer les prospects de n'importe quel canal en plus de missions, 24h/24 et 7j/7. Votre IA employé est configurée pour connaître votre entreprise et vos clients."}/>
